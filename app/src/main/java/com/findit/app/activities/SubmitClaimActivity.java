...
import com.findit.app.utils.CloudinaryHelper;
...
public class SubmitClaimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etProofDescription = findViewById(R.id.et_evidence_description);
        ivProofImage = findViewById(R.id.iv_evidence_preview);
        layoutUploadProofPlaceholder = findViewById(R.id.btn_upload_evidence);
