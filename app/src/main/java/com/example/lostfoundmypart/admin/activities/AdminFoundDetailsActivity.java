...
public class AdminFoundDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_found_details);
        ...
        txtDate.setText(
                getIntent().getStringExtra("dateFound"));
